	...
	.text
.Ltext0:
	.section	.text.buffer_scale_back_q15_to_q7,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	buffer_scale_back_q15_to_q7, %function
buffer_scale_back_q15_to_q7:
.LFB198:
	.file 1 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\arm_pool_q7_HWC.c"
	.loc 1 43 1
...
.LCFI1:
	...
	bx	lr
.LFE198:
	.size	buffer_scale_back_q15_to_q7, .-buffer_scale_back_q15_to_q7
	.section	.text.compare_and_replace_if_larger_q7,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	compare_and_replace_if_larger_q7, %function
...
.LCFI4:
	...
	ldr	pc, [sp], #4
.LFE199:
	.size	compare_and_replace_if_larger_q7, .-compare_and_replace_if_larger_q7
	.section	.text.accumulate_q7_to_q15,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	accumulate_q7_to_q15, %function
...
.LBB30:
.LBB31:
	.file 3 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\cmsis_gcc.h"
	.loc 3 1023 7
	ldr	r3, [sp, #44]
	and	r3, r3, #31
	str	r3, [sp, #44]
...
.LBB33:
	...
	ldr	r3, [sp, #56]
	.syntax unified
@ 1961 "C:\Users\Devan\Documents\SEGGER Embedded Studio for ARM Projects\Executable_1\cmsis_gcc.h" 1
	sxtb16 r3, r3
@ 0 "" 2
	.thumb
	.syntax unified
...
.LBB39:
	...
	ldr	r2, [sp, #76]
	.syntax unified
@ 1731 "C:\Users\Devan\Documents\SEGGER Embedded Studio for ARM Projects\Executable_1\cmsis_gcc.h" 1
	qadd16 r3, r3, r2
@ 0 "" 2
	.thumb
	.syntax unified
...
.LCFI7:
	...
	ldr	pc, [sp], #4
.LFE200:
	.size	accumulate_q7_to_q15, .-accumulate_q7_to_q15
	.section	.text.arm_maxpool_q7_HWC,"ax",%progbits
	.align	1
	...
	.thumb_func
	.fpu softvfp
	.type	arm_maxpool_q7_HWC, %function
arm_maxpool_q7_HWC:
.LFB201:
	.loc 1 177 1
...
.L36:
	...
	b	.L37
.L38:
	.loc 1 218 17 discriminator 2
	ldrh	r3, [sp, #8]
	mov	r2, r3
	ldr	r1, [sp, #40]
	ldr	r0, [sp, #20]
	bl	compare_and_replace_if_larger_q7
	.loc 1 216 52 discriminator 2
	ldrh	r3, [sp, #8]
	ldr	r2, [sp, #40]
	add	r3, r3, r2
	str	r3, [sp, #40]
...
.LCFI10:
	...
	ldr	pc, [sp], #4
.LFE201:
	.size	arm_maxpool_q7_HWC, .-arm_maxpool_q7_HWC
	.section	.text.arm_avepool_q7_HWC,"ax",%progbits
	.align	1
	...
	.thumb_func
	.fpu softvfp
	.type	arm_avepool_q7_HWC, %function
arm_avepool_q7_HWC:
.LFB202:
	.loc 1 328 1
...
.L55:
	...
	b	.L56
.L57:
	.loc 1 371 17 discriminator 2
	ldrh	r3, [sp, #8]
	mov	r2, r3
	ldr	r1, [sp, #44]
	ldr	r0, [sp, #28]
	bl	accumulate_q7_to_q15
	.loc 1 372 22 discriminator 2
	ldrsh	r3, [sp, #50]
	uxth	r3, r3
	adds	r3, r3, #1
	uxth	r3, r3
	strh	r3, [sp, #50]	@ movhi
	.loc 1 369 52 discriminator 2
	ldrh	r3, [sp, #8]
	ldr	r2, [sp, #44]
	add	r3, r3, r2
	str	r3, [sp, #44]
.L56:
	.loc 1 369 13 discriminator 1
	ldr	r2, [sp, #44]
	ldr	r3, [sp, #40]
	cmp	r2, r3
	bcc	.L57
	...
	ldr	r1, [sp, #20]
	ldr	r0, [sp, #28]
	bl	buffer_scale_back_q15_to_q7
.LBE46:
	.loc 1 341 44 discriminator 2
	ldrsh	r3, [sp, #54]
	uxth	r3, r3
	adds	r3, r3, #1
	uxth	r3, r3
...
.LCFI13:
	...
	ldr	pc, [sp], #4
.LFE202:
	.size	arm_avepool_q7_HWC, .-arm_avepool_q7_HWC
...
.Letext0:
	...
	.file 6 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\arm_math.h"
	.file 7 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\arm_common_tables.h"
	.file 8 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\arm_nn_tables.h"
...
.Ldebug_abbrev0:
	...
	.4byte	0x1a26
	.4byte	0x1331
	.ascii	"arm_avepool_q7_HWC\000"
	.4byte	0x1491
	.ascii	"arm_maxpool_q7_HWC\000"
	.4byte	0x15bf
	.ascii	"accumulate_q7_to_q15\000"
	.4byte	0x17d4
	.ascii	"compare_and_replace_if_larger_q7\000"
	.4byte	0x18a8
	.ascii	"buffer_scale_back_q15_to_q7\000"
	.4byte	0x1908
	.ascii	"arm_nn_read_q7x4\000"
	.4byte	0x1935
	.ascii	"arm_nn_read_q15x2\000"
	.4byte	0x1962
	.ascii	"arm_nn_read_q7x4_ia\000"
	.4byte	0x1995
	.ascii	"__SXTB16\000"
	.4byte	0x19c2
	.ascii	"__QADD16\000"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 10 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.52c/include/string.h"
	.byte	0x3
	.uleb128 0x18b
	.uleb128 0xa
	.byte	0x5
	...
	.4byte	.Ldebug_macro6
	.byte	0x4
	.file 11 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.52c/include/math.h"
	.byte	0x3
	.uleb128 0x18c
	.uleb128 0xb
	.byte	0x7
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 12 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.52c/include/float.h"
	.byte	0x3
	.uleb128 0x18d
	.uleb128 0xc
	.byte	0x7
	.4byte	.Ldebug_macro8
	.byte	0x4
	.file 13 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 4.52c/include/limits.h"
	.byte	0x3
	.uleb128 0x18e
	.uleb128 0xd
	.byte	0x7
	...
	.byte	0x4
	.file 14 "C:\\Users\\Devan\\Documents\\SEGGER Embedded Studio for ARM Projects\\Executable_1\\arm_nnfunctions.h"
	.byte	0x3
	.uleb128 0x20
	.uleb128 0xe
	.byte	0x5
...
.LASF1029:
	...
	.ascii	" for ARM Projects\\Executable_1\\arm_pool_q7_HWC.c\000"
.LASF141:
